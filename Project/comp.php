...
<div class="container-fluid pl-5 pr-5">
  <h1 class="text-center mt-5">-: Computer Technology :-</h1>
  <p class="ml-5 mr-5 mt-5"><b><u>About Department :</u></b><br>

  The Computer Technology Department is provide three years diploma program which start from 2005 in the institute. It Strives to offer student excellent instruction and Educational opportunities in information technology world. It endeavors to provide its student a durable technical foundation in an environment of rapid technical change, to enable and promote their professional growth through contact with best profession practice, and to play a role of resource and technical leadership in the regional communities.<br><br>
  Understand the fundamental of discipline of computer science programming, data structure design, computer Architecture and maintenance, relational database, programming language design, software engineering, software testing, operating system, computer graphics, computer networking and advance programming.
<br><br><br>
 We Will Provide Student With:
<ul class="ml-5 mr-5">
<li>A Strong theoretical and practical background across the computer science discipline with an emphasis on software development.</li> 
 <li>An understanding of their professional and ethical responsibilities.</li>
<li>A rich skill set and practical experience enabling them to become valuable and creative contributors society.</li>
</ul>
</p>
