...
<div class="container-fluid pl-5 pr-5">
  <h1 class="text-center mt-5">-: Instrumentation Engineering :-</h1>
  <p class="ml-5 mr-5 mt-5"><b><u>About Department :</u></b><br><br>
    <b>A highly interdisciplinary branch covers major aspects of chemical,mechanical and electrical fundamentals. It deals with measurement control and optimisation.</b><br><br>
The competition due to globalization has resulted in better process control, optimum utilization of resources & higher level of automation in all industry sectors.  The demand for automation is increasing day by day.  To face these challeges, competent Instrumentation and control engineers are required.  Instrumentation and control engineering involves the applictions of instruments for measurement and control.  Design of instruments and their applictions are two inherent aspects in Instrumentation.  Further, installation, commissioning and maintenance of Instrumentation systems are interal part of Instrumenttion and control engineering.  Instrumentation Engineers are the lead persons for Automation and Control.  Department of Instrumentation is established in the year 1995 with sanctioned intake as (30).  Further in the year 1999 intake increased to (40).   Final year Instrumentation Result is 100% from last 5 years also department is rated as exellant by MSBTE in the academic year 2016-17 for academic performance.</p>
</div>
